...
def lic():
   ...
   print(name)
   dob = "12/10/12"
   label_dob["text"]+=str(dob)
   print(dob)
   address = "83 Moon Crecent Street M54 9MK Moonocco"
   label_address["text"]+=str(address)
   print(address)
   vehicle = "Two Wheeler, Four Wheeler"
   label_vehicle_type["text"]+=str(vehicle)
   print(vehicle)

    
# Create a button
button1 = Button(root,text = "Show my Driving License", command=lic)
